...
class ToolAdapter:
    ...
    # Bolt: Class-level cache for formatted tool definitions to avoid redundant formatting
    ...
    @classmethod
    def _get_formatted_tool(cls, util_name: str, definition: Dict[str, Any]) -> Dict[str, Any]:
        """
        Internal helper to format a tool definition and cache it.
        """
    ...
    def get_all_tools(cls) -> List[Dict[str, Any]]:
        ...
        """
        # Bolt: Return shallow copies of cached tool definitions
        return [
            cls._get_formatted_tool(util_name, definition).copy()
    ...
    def get_tool_by_name(cls, name: str) -> Optional[Dict[str, Any]]:
        ...
        """
        # Bolt: Optimized lookup using cached definitions
        for util_name, definition in cls.TOOL_DEFINITIONS.items():
            if definition["name"] == name:
                return cls._get_formatted_tool(util_name, definition).copy()
        return None
    ...
    def get_enabled_tools(cls, enabled_utils: List[str]) -> List[Dict[str, Any]]:
        ...
        Returns:
            ...
            OpenAI format.
        """
        # Bolt: Convert to set for O(1) lookups while preserving original definition order
