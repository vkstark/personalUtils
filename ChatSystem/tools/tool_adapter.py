...
class ToolAdapter:
    ...
    # Bolt: Cache for formatted OpenAI tool definitions to avoid redundant work
    ...
    def _get_formatted_tool(cls, util_name: str) -> Optional[Dict[str, Any]]:
        """
        Retrieves and caches a formatted tool definition.
        """
    ...
    def get_all_tools(cls) -> List[Dict[str, Any]]:
        ...
        """
        # Bolt: Optimized to use cached formatted tools
        return [
    ...
    def get_enabled_tools(cls, enabled_utils: List[str]) -> List[Dict[str, Any]]:
        ...
        return [
            cls._get_formatted_tool(util_name)
            for util_name in enabled_utils
            if util_name in cls.TOOL_DEFINITIONS
        ]
