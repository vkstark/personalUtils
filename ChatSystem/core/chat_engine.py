...
class ChatEngine:
    ...
    def _handle_tool_calls(
        ...
        try:
            ...
            # Batch tool-related message additions for durability and performance.
            # We exit the batch context BEFORE the final LLM call to ensure
            # tool results are persisted to disk even if the network call fails.
