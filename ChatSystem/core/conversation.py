...
When users ask you to perform tasks, analyze if any tools can help. Break complex tasks into steps and execute them systematically. Always explain what you're doing and provide clear results."""
    ...
    def get_messages(self, include_system: bool = True) -> List[Dict[str, Any]]:
        ...
        # If including system prompt, return the cached list
        if include_system:
    ...
    def clear_history(self, keep_system: bool = True):
        ...
        # Proactively rebuild caches after a full clear if we're in a high-performance context
        # but for now just invalidating is enough.
    ...
    def _save_history(self):
        ...
        try:
            ...
            # Populate dumped messages cache if it's empty
            ...
            with open(self.history_file, "w", encoding="utf-8") as f:
                # Remove indent=2 to speed up serialization and reduce file size
