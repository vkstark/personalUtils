...
When users ask you to perform tasks, analyze if any tools can help. Break complex tasks into steps and execute them systematically. Always explain what you're doing and provide clear results."""
    ...
    def _reset_state(self):
        ...
        Useful after bulk modifications to the message history.
        """
        total_tokens = 0
        role_counts = defaultdict(int)
        for msg in self.messages:
            total_tokens += msg.get_token_count(self.encoding)
    ...
    def _load_history(self):
        ...
        try:
            ...
            # Bolt: Update total tokens and role counts using centralized method for accuracy
            self._reset_state()
