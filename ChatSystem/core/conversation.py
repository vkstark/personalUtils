...
When users ask you to perform tasks, analyze if any tools can help. Break complex tasks into steps and execute them systematically. Always explain what you're doing and provide clear results."""
    ...
    def _reset_state(self):
        """Rebuilds the internal state (tokens, role counts) from scratch."""
        self._total_tokens = 0
        self._role_counts = collections.defaultdict(int)
    ...
    def _load_history(self):
        ...
        try:
            ...
            # Bolt: Update tokens and role counts for newly loaded messages
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        # Bolt: Use incrementally tracked role counts for O(1) performance
        self._cached_summary = {
            "total_messages": len(self.messages),
            "messages_by_role": {r: c for r, c in self._role_counts.items() if c > 0},
